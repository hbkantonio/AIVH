...
<body>
    <form id='frmMain' name='frmMain' action="" method='post' enctype="multipart/form-data">
        <table width="1024" border="0">
            <tr class="a">
                <th colspan="6" scope="row">
                    <table width="800" border="0">
                        <tr>
                            <td width="116"><strong><a href="javascript:return false;" id="aRegresar">
                                <img src="images/FleReg1.png" alt='Regresar al Men&uacute; de Opciones' name="regresar" id="regresar" width="60" height="28" border="0"></a> </strong></td>
                            <td width="554">
                                <div align="center">
                                    <strong>
                                        <img src="images/bullet.gif" width="16" height="12"><span class="Estilo1">Seguimiento Expediente de Comisi&oacute;n de Usuarios y Conducta</span></strong>
                                </div>
                            </td>
                            <td width="116">&nbsp;</td>
                        </tr>
                    ...
                    <table width="900" border="0">
                        <tr>
                            ...
                            <th width="819" scope="col">
                                <table width="781" border="0">
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Folio: </div>
                                        </td>
                                        <td colspan="2" class="submenu2">
                                            <div align="left"><%=idFolioUnidad%> </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Asociaci&oacute;n: </div>
                                        </td>
                                        <td colspan="2" class="submenu2">
                                            <div align="left"><%=strAsociacion%></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="menu_activo">
                                        ...
                                        <td colspan="2" class="submenu2">
                                            <div align="left"><%=strUnidad%></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="221" class="menu_activo">
                                            <div align="right">Fecha de apertura: </div>
                                        </td>
                                        <td width="550" colspan="2" class="submenu2">
                                            <div align="left"><%=FormatDateTime(strFecha,vbLongDate)%></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="menu_activo">
                                    ...
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Descripci&oacute;n Corta:</div>
                                        </td>
                                        <td colspan="2">
                                            <div align="left">
							    ...
							    set RsAdo = Nothing%>
                                    ...
                                    <tr  id="trArticuloO">
                                        <td class="menu_activo">
                                            <div align="right">Observaciones del articulo:</div>
                                        </td>
                                        <td colspan="2">
                                            <div align="left">
                                                <input name="txtObservaciones" type="text" id="txtObservaciones" size="50" maxlength="50" value="">
                                                <input type="button" id="btnAgregarA" value="Agregar">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Articulos:</div>
                                        </td>
                                        <td colspan="2">
                                            <div align="left">
                                                <table width="500" border="1" id="tblArticulos">
                                                    <thead>
                                    ...
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Categor&iacute;a de infracci&oacute;n:</div>
                                        </td>
                                        <td colspan="2">
                                            <div align="left">
			...
			set RsAdo = Nothing%>
                                    ...
                                    <tr>
                                        ...
                                        <td class="menu_activo">
                                            <div align="right">Resoluci&oacute;n:</div>
                                        </td>
                                        <td>
                                            <div align="left">
			...
			set RsAdo = Nothing%>
                                    ...
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Fecha inicial de la resoluci&oacute;n:</div>
                                        </td>
                                        <td>
                                            <div align="left">
                                                <input name="txtFechaIni" type="text" id="txtFechaIni" size="10" maxlength="10" value="<%=strFechaIni%>" <%if idEstatus = 3 then response.write "disabled"  end if %>>
                                            </div>
                                        </td>
                                        <td>
                                            <div align="left" id="divSegundaFechaIni" style="display: none;">
                                                <input name="txtFechaIni2" type="text" id="txtFechaIni2" size="10" maxlength="10" value="<%=strFechaIni2%>" <%if idEstatus = 3 then response.write "disabled"  end if %>>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Fecha final de la resoluci&oacute;n:</div>
                                        </td>
                                        <td>
                                            <div align="left">
                                        ...
                                        <td>
                                            <div align="left" id="divSegundaFechaFin" style="display: none;">
                                    ...
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Anexar documento PDF:</div>
                                        </td>
                                        <td colspan="2">
                                            <div align="left">
                                                <input id="attach1" name="attach1" type="file" size="35">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Nombre de PDF que se esta anexando:</div>
                                        </td>
                                        <td colspan="2">
                                            <div align="left">
                                    ...
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Documentos PDF Anexados:</div>
                                        </td>
                                        <td colspan="2">
                                            <div align="left">
                                                <%IF strDoctoPDF <> "" THEN %><%vlArchivosAnexados=1%> <%END IF%>
                                                <%
							...
							do while not RsAdo2.eof%>
                                                <a id="<%=RsAdo2("FIDOCTO_PDF")%>1" target="_blank" href="../../../DoctosPermisos/DoctosComision/<%=RsAdo2("FIDOCTO_PDF")%>">
                                                    <img src="../../BaseIncluidos/images/pdf.jpg" width="20" height="20" border="0" title="<%=RsAdo2("FCNOMBRE_PDF")%>"></a>
                                                <%if idEstatus <> 3 THEN%>
                                                <a id="<%=RsAdo2("FIDOCTO_PDF")%>" class="eliminar">
                                                    <img src="../../BaseIncluidos/images/error.png" width="10" height="10" border="0" title="Eliminar <%=RsAdo2("FCNOMBRE_PDF")%>"></a>
                                                <%end if%>
                                                <%
                               RsAdo2.movenext
							loop
							set RsAdo2 = Nothing
                                    ...
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Nuevo comentario:</div>
                                        </td>
                                        <td colspan="2">
                                            <textarea name='txtNota' maxlength='300' cols='80' rows='5' id='txtNota'></textarea></td>
                                    </tr>
                                     <%if idEstatus <> 3 THEN%>
                                    <tr>
                                        <td>
                                            <a id="aActualizar" href="javascript:return false;">
                                                <img src="images/Actualizar_1.png" name="btnActualizar" id="btnActualizar" border="0"></a>
                                        </td>
                                        <td colspan="2">&nbsp;
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <div align="left">
                                                <div id="message-alerta" class="ui-widget"></div>
                                        </td>
                                    </tr>
                                    <%If idEstatus = 3 then%>
                                    <tr>
                                        <td class="menu_activo">
                                            <div align="right">Fecha Concluido:</div>
                                        </td>
                                        <td colspan="2">
                                            <div align="left">
							...
							do while not RsAdo2.eof%>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <div align="left"><%=RsAdo2("FCOBSERVACIONES")%></div>
                                                    </th>
                                                </tr>
                                                <%RsAdo2.movenext
							  loop
							  set RsAdo2 = Nothing
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <div align="left">
                                                <%if idEstatus <> 3 THEN%>
                                                <a id="aCerrar" href="javascript:return false;">
                                                    <img src="images/Concluir_1.png" name="btnCerrar" id="btnCerrar" border="0"></a>
                                                 <%else%>
                                                 <a id="aApelar" href="javascript:return false;">
                                                     <img src="images/apelar_1.png" name="btnApelar" id="btnApelar" border="0"></a> 
                                                <%end if%>
                                            </div>
                                        </td>
                                    </tr>
        ...
        <input type='hidden' name='vlEstatus' id='vlEstatus' value='<%=idEstatus%>'>
    </form>
</body>
</html>
